    ...
    return (
        <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
            ...
            >
                ...
                <a
                    className="bg-white p-4 text-gray-700 flex items-center text-[1.2rem] gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10"
